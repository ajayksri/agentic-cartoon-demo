...
OPENAI_ROLE_MAP: Mapping[ProviderMessageRole, str] = {
...
class OpenAITransport:
    ...
    def complete(
        ...
        *,
        ...
        messages = [
            {"role": OPENAI_ROLE_MAP[msg.role], "content": msg.content}
...
class OpenAIAdapter(BaseRemoteProvider):
    def __init__(
        self,
        *,
        api_key: str,
        ...
        **base_kwargs: object,
        ...
        resolved_transport = transport or OpenAITransport(api_key=api_key)
        super().__init__(
